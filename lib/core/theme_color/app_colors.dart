...
class AppColors {
  ...
  static const Color lightText = Color(0xFF1E1E1E); // Dark Gray/Black
  static const Color lightHint = Color(0xFF777777); // Medium Gray
  ...
  static const Color darkError = Color(0xFFEF5350); // Soft Red
