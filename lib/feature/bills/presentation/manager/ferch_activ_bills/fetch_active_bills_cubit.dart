...
class FetchActiveBillsCubit extends Cubit<FetchActiveBillsState> {
  FetchActiveBillsCubit(this.fetchActiveBillsUseCase) : super(FetchActiveBillsInitial());
  ...
  Future<void> fetchActiveBills(FetchBillsParam param) async {
    ...
    result.fold(
          (failure) => emit(FetchActiveBillsFailureState(errMessage: failure.errMessage)),
