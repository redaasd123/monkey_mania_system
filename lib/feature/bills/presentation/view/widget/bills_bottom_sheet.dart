                ...
                onTap: () async {
                  ...
                  if (pickedDate != null) {
                    setState(() {
                      ...
                      final formattedDate = DateFormat('y-M-d').format(pickedDate);
                      children[childIndex]['birthDate'] = _toEnglishDigits(formattedDate);
                    });
                  }
                },
              ),
                      ...
                      children: [
                        ...
                        Expanded(
                          ...
                          child: TextFormField(
                            ...
                            keyboardType: TextInputType.phone, // 👈 يظهر لوحة أرقام
                            inputFormatters: [
